    ...
    return () => (
      <div class={cn('relative mt-8px w-full h-400px b b-cyan-900 rd-4px bg-[#162a43]', props.class)}>
        ...
        <div class="relative z-10 flex flex-col gap-8px h-full overflow-y-auto py-12px">
          {/* 高亮滑块：渐变背景 + 上下渐变边框 + 左右荧光条，点击选中时滑动而来 */}
          <div
            ...
            style={{
              ...
              background:
                'linear-gradient(to right, rgba(9,150,175,0.10), rgba(9,150,175,0.45) 20%, #0996af 40%, #0996af 60%, rgba(9,150,175,0.45) 80%, rgba(9,150,175,0.10)) top/100% 1px no-repeat, linear-gradient(to right, rgba(9,150,175,0.10), rgba(9,150,175,0.45) 20%, #0996af 40%, #0996af 60%, rgba(9,150,175,0.45) 80%, rgba(9,150,175,0.10)) bottom/100% 1px no-repeat, linear-gradient(87deg, rgba(41,79,132,0.60) -3.66%, rgba(41,79,132,0.27) 47.74%, rgba(25,140,169,0.60) 103.8%)',
            }}
          >
            {/* 左右荧光条（#00EAFF） */}
