...
/** 建设内容及规模 */
const BUILDING_DESC = '对康成酒厂和南洋卷烟厂实施改造，并新增地下停车场。';

/** 关键信息 */
const KEY_INFO = [
  { label: '实施主体', value: '硚口城建集团' },
  // { label: '片区责任主体', value: '车站街道' },
  { label: '开工时间', value: '2025年7月' },
...
export const BasicInfo = defineComponent({
  ...
  setup() {
    return () => (
      <div
        class="h-full max-h-800px p-12px rd-16px backdrop-blur-10px overflow-auto scrollbar-none"
