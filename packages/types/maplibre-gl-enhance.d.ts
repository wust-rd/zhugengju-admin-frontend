...
export declare class CRS {
	 ...
	 */
	constructor(epsgCode: string, wktOrExtent?: string | [number, number, number, number], extent?: [number, number, number, number]);
 ...
 */
export declare function proj4(fromProjection: string, toProjection: string, coordinates: [number, number]): [number, number];
...
export declare namespace proj4 {
	 ...
	 */
	function toMGRS(point: [number, number] | {
		x: number;
		y: number;
	...
	const transform: (source: string | ProjProjection, dest: string | ProjProjection, point: [number, number]) => [number, number];
	const mgrs: unknown;
}
...
// 运行时经 vite alias -> packages/core/utils/maplibre-gl-shim.ts 桥接 window.maplibregl）。
