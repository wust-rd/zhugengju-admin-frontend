...
export const FUND_MODE_CARDS: FundModeCard[] = [
  ...
  },
  {
    ...
    period: '截止汇总周期：2026-06 二季度',
    lines: [
      '第一批更新片区80个 已完成投资250亿元 / 年度投资计划550亿元',
      '第二批更新片区102个 已完成投资250亿元 / 年度投资计划500亿元',
    ],
  },
  {
    key: 'project',
    ...
    period: '截止汇总周期：2026-06 二季度',
    lines: [
      '市级更新片区内项目668个 已完成投资500亿元 / 年度投资计划1100亿元',
      '市级更新片区外项目423个 已完成投资250亿元 / 年度投资计划400亿元',
    ],
  },
];
