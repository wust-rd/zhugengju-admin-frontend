...
import { ProjectTabContent } from '@jeesite/display/components/project-tab-content';
    ...
    return () => (
      <>
        <div class="flex-1 w-1430px h-full relative">
          ...
          <img src={`${OSS_BASE}/知音东苑片-${activeTab.value}.webp`} class="w-full h-full object-fill -ml-4px" />
